function public_vars = update_kalman_filter(read_only_vars, public_vars)
%UPDATE_KALMAN_FILTER Summary of this function goes here

mu = public_vars.kf.mu;
sigma = public_vars.kf.sigma;
...
public_vars.kf.mu = mu;
public_vars.kf.sigma = sigma;
